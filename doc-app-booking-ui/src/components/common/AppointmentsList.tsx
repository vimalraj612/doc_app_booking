        ...
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 mb-3">
          ...
          <fieldset className="flex items-center gap-3 flex-wrap">
            ...
            <div className="flex items-center gap-2">
              <button
                ...
                title="Previous day"
                className="p-1 rounded-md bg-gray-100 hover:bg-gray-200 text-sm"
              ...
              <input
                ...
                className="border rounded px-2 py-1 text-xs h-8 w-32"
              ...
              <button
                className="ml-1 p-1 rounded-md bg-blue-600 text-white hover:bg-blue-700 transition flex items-center justify-center disabled:opacity-60 h-8 w-8"
                onClick={() => fetchAppointments(dateRange)}
                disabled={appointmentsLoading}
                title="Search"
              >
                <svg xmlns="http://www.w3.org/2000/svg" className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2"><circle cx="11" cy="11" r="7" /><line x1="21" y1="21" x2="16.65" y2="16.65" /></svg>
              </button>
            </div>
          </fieldset>
          ...
          <div className="flex items-center gap-2">
            ...
            <button
              ...
              onClick={() => { setStatusFilter('ALL'); setDateRange({ start: '', end: '' }); fetchAppointments({ start: '', end: '' }); }}
              title="Clear filters"
            >
              Clear
            </button>
            ...
            <div className="grid gap-4 sm:grid-cols-2 md:grid-cols-3">
              {filteredAppointments.map((appt: Appointment) => {
                ...
                return (
                  <div
                    key={appt.id}
                    className={`bg-white rounded-xl border ${bg.replace('bg-','border-')} shadow p-4 flex gap-2 hover:shadow-md transition`}
                  >
                    {/* colored accent bar */}
                    <div className={`w-1 rounded ${dot} mr-2`} />
                    <div className="flex-1 flex flex-col gap-2">
                      ...
                      <div className="text-xs text-gray-600 mb-1">
                        ...
                        {appt.notes !== undefined && appt.notes !== null && (
